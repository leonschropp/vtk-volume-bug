...
The same result is obtained by passing this Hexahedron to [Calculix (CGX)](https://www.calculix.de/) or [Paraview](https://www.paraview.org/) and
using their volume functions. Both CGX and Paraview give out **8666.666** for this exact quadratic Hexahedron!
